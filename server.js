...
app.get('/api/bot/status', (req, res) => {
  res.json({
    ...
    shop3: { isRunning: bots.shop3.isRunning, config: bots.shop3.config },
    shop4: { isRunning: bots.shop4.isRunning, config: bots.shop4.config }
  });
});
...
app.get('/api/bot/logs', (req, res) => {
  res.json({
    ...
    shop3: bots.shop3.logs,
    shop4: bots.shop4.logs
  });
});
